...
Route::group(['middleware' => ['XSS']] ,function() {     
    ...
    Route::namespace('Admin')->prefix('superadmin')->name('admin.')->group(function(){
		Route::group(['middleware' => ['auth:misadmin','prevent-back-history']], function() {
			...
			Route::post('delete-Full-Customer-Detail', [DashboardController::class,'deleteFullCustomerDetail'])->name('deleteFullCustomerDetail');
			...
			Route::get('active-users',[AgreementReportController::class,'activeUsers'])->name('activeUsers'); 

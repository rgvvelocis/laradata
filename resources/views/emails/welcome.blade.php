                    ...
                    <meta name="x-apple-disable-message-reformatting"> 
                        ...
                        <meta name="robots" content="noindex, follow">
                            ...
                            <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
                                ...
                                <center style="width: 100%; background-color: #f1f1f1;padding: 15px 0;">
                                        ...
                                        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                                                    ...
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td class="logo" style="text-align: center;">
                                                                <h1><a href="{{route('customerlogin')}}">Login Details</a></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
                                                    <img src="{{asset('/public/email.png')}}" alt="" style="width: 150px; max-width: 600px; height: auto; margin: auto; display: block;">
                                                </td>
                                            </tr> 
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                                                    <h2>Hello {{ucfirst($customer->customer_name)}} </h2>
                                                                    <h3>Your registration is successfully completed!!</h3>
                                                                    <h3>Please login with this Username & Password.</h3>
                                                                    <p>Your Username:<b> {{$customer->username}}</b></p>
                                                                    <p>Password:<b> {{$customer->password}} </b></p>
                                                                    <p><a href="{{route('customerlogin')}}" style="border-radius: 5px;background: #30e3ca;color: #ffffff;padding: 10px 15px;display: inline-block;text-decoration: none;" class="btn btn-primary">GO WEBSITE</a></p>
                                                                    
                                                                    <h3>Thanks & Regard<br>Team</h3>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>

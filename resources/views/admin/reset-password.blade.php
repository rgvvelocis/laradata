                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex_">
                                    <h4 class="card-title mb-0 flex-grow-1">Change Password</h4>(At least 8 characters, one uppercase and one lowercase letter, one symbol, one number)
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form method="POST" action="{{ route('admin.resetPasswordPost',[$token,$pageRoute]) }}" id="password_frm" class="w-100" autocomplete="off">
										{{ csrf_field() }}
                                        <div class="row gy-6">

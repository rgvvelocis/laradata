...
@section('title', 'Edit Customer User')
...
<!-- start page title -->
	...
	{!! Form::open(array('route' => ['admin.admin-customer.update', $data->id],'method'=>'PATCH','id' => 'userFrm','files' => 'true','enctype'=>'multipart/form-data')) !!}
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				 @if (count($errors) > 0)
						...
						<div class="row gy-4">
							...
							<div class="col-xxl-3 col-md-6">
								<div>
									...
									<select name="your_state" id="your_state" class="form-select"  required>
							...
							<!--end col-->
							 	<div class="col-xxl-3 col-md-6">
								<div>
									<label for="yourcity" class="form-label">{{ __('City*') }}</label>
									<select name="yourcity" id="yourcity" class="form-select"  required>
										<option value="">Select State</option>

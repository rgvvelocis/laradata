	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="GET" action="{{ route('admin.reportRelease') }}">
					<div class="row gy-4">
							...
							@php $sr = ($data->currentPage() - 1) * $data->perPage(); @endphp
								...
								<tr>
									<td>{{ $sr + $loop->iteration }} </td>	
									   ...
									   <td><a  style="text-align: center;display: block;" href="{{ route('admin.viewReport', [$user->id,'release']) }}"><i class="ri-eye-fill"></i></a></td>  
									   <td>

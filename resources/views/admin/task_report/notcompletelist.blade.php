...
@section('title', 'Non-Complete Task List')
	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box d-sm-flex align-items-center justify-content-between">
				<h4 class="mb-sm-0">Non-Complete Task List</h4>
	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="GET" action="{{ route('admin.notCompleteList') }}">
					<div class="row gy-4">
								...
								<tr>
									<td>{{ $sr + $loop->iteration }} </td>	
									   ...
									   <td>{{ date('d-m-Y',strtotime($user->user_sub_date)) }} </td>
									    <td>{{$user->getFinalSubmission->total_attempt_record}}</td>
									   <td>{{$user->getFinalSubmission->correct}}</td>
									   <td>{{$user->getFinalSubmission->incorrect}}</td>  
									   <td><a  style="text-align: center;display: block;" href="{{ route('admin.viewReport', [$user->id,'notcomplete']) }}"><i class="ri-eye-fill"></i></a> </td>  
									   <td>

...
<html style="font-size: 16px;">
  <head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('public/login/css/agent.css')}}" media="screen"> -->
...
<body>
  <div class="session">
    ...
    <form action="{{ route('agent.login') }}" method="POST" class="log-in" autocomplete="off"> 
    @csrf  
      <h4>Agent <span>Login</span></h4>
      @if (session('error'))
      ...
      <div class="floating-label">
        <input placeholder="Username" type="text" name="username" id="username" required autocomplete="off">
      ...
      <div class="floating-label">
        <input placeholder="Password" type="password" name="password" id="password-input" required autocomplete="off">
